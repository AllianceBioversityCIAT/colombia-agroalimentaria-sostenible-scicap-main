...
export class AddedLongDescriptionColumnIndicators1729521083010
  implements MigrationInterface
{
  name = 'AddedLongDescriptionColumnIndicators1729521083010';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`indicator_types\` ADD \`long_description\` text NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`indicators\` ADD \`long_description\` text NULL`,
    );
...
<p style="margin-top:0pt; margin-bottom:8pt;">Reference - <a href="https://drive.google.com/file/d/1v0O5wt4z3bgs_wCYa7H2FifTVSAXAVjl/view" style="text-decoration:none;"><u><span style="color:#467886;">One CGIAR PRMF Glossary</span></u></a></p>' WHERE \`indicator_type_id\` = ${IndicatorTypeEnum.OUTCOME}`,
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`indicators\` DROP COLUMN \`long_description\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`indicator_types\` DROP COLUMN \`long_description\``,
    );
  }
}
